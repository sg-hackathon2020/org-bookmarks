                ...
                <div className="container mb-2 pb-2">
                    <Navbar bg="dark" variant="dark" fixed="top">
                        ...
                        <Nav className="mr-auto">
                             <Nav.Link as={Link} to="/">Home</Nav.Link> : null
                            <Nav.Link as={Link} to="/groups">groups</Nav.Link> : null
                            <Nav.Link as={Link} to="/auth">auth</Nav.Link> : null
                            <Nav.Link as={Link} to="/logout">logout</Nav.Link> : null
                        </Nav>
                    </Navbar>
                    <br/>
                    {/*<Switch>
